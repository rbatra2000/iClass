...
class SignUpViewController: UIViewController {
    ...
    @IBAction func confirm(_ sender: UIButton) {
        if (id.text != "" && name.text!.isName && phone.text!.isPhoneNumber) {
            ...
            let alert = UIAlertController(title: "Please input all the fields correctly.", message: "Ensure that you put your full name and complete phone number (no dashes or parentheses).", preferredStyle: .alert)
